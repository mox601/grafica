 ...
 *  Celeste Fowler, 1997
 *
 *  An example of using the accumulation buffer to interpolate
 *  contrast, saturation and brightness of an image.
 *
 */
...
main(int argc, char *argv[])
{
    ...
    printf("drag the mouse left and right to decrease or increase the interpolation\n");
    glutMainLoop();
    return 0;
}

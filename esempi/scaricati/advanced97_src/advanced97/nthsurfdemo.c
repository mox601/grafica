 ...
 *  Brad Grantham, 1997
 *
 *  Demonstrates what is meant by the 'nth-surface'.  Useful for
 *  understanding how CSG operations work in OpenGL.
 */
...
int stage = 6;
enum {COLOR, DEPTH, STENCIL} bufferInterest = COLOR;

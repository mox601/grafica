 ...
 *  Tom McReynolds, 1997
 *
 *  An example of using multi-pass rendering techniques to produce
...
{
    /* XXX hack for two button mice (shift+left = middle) */
    if (glutGetModifiers() & GLUT_ACTIVE_SHIFT && button == GLUT_LEFT_BUTTON)

...
GLdouble* coordinate = malloc(2 * dettaglio * sizeof(GLdouble));
...
//	setMaterialType(1,1,0, 'p');
	...
	drawCircle(5.0f, 5, 90.0f, 0.0f);
	drawCircle(5.0f, 5, 180.0f, 90.0f);
	drawCircle(5.0f, 5, 270.0f, 180.0f);
	drawCircle(5.0f, 5, 360.0f, 270.0f);

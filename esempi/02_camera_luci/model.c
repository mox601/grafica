...
void drawRearWall(GLfloat lunghezza, GLfloat dettaglio, GLfloat segno_inclinazione, GLfloat altezza) {
	...
	GLfloat altezza_w3_high = altezza_w2_high * 0.9f; 
...
GLfloat profondita = lunghezza * profondita_lunghezza_ratio; 
...
glPushMatrix();
glTranslatef(0.0f, lunghezza_w2_high, 0.0f); 
glRotatef(-90.0f, 0.0f, 0.0f, 90.0f);

glutSolidSphere(0.5f, 10.0f, 10.0f);

GLfloat spigolo_laterale_back_w3_high = -1.1f;
GLfloat spigolo_laterale_front_w3_high = 1.1f;

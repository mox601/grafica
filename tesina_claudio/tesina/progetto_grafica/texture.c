...
const char *szTextureFiles[TEXTURE_COUNT] = {
	"textures/dirtysand.ppm",
	"textures/moon2.ppm",
	"textures/gold.ppm",
	"textures/marmoverde.ppm",
	"textures/tovaglia.ppm",
	"textures/travertino.ppm",
	"textures/legno_massiccio.ppm",
	"textures/cassettone.ppm",
	"textures/marmo_macchie.ppm",
	"textures/marmo_bianco_feasible.ppm",
	"textures/caravaggio.ppm",
	"textures/Creazione.ppm",
	"textures/venere_botticelli.ppm",
	"textures/ultima_cena.ppm"
	};
